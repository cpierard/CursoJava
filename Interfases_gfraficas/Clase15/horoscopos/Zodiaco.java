...
public class Zodiaco extends JFrame {
	...
	public Zodiaco() {
		...
		etiqueta.setText("<html>" + "<center>"+signo +"</center>"+ "<br>" + caracteristicas +"</html>");
